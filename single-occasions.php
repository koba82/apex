...
<div class="content-wrapper mod-occ" role="main">
		...
		<div class="content-block">
			<div class="content content-width c-flex-image-slider">
				...
				<div class="flex-image-slider">
					<div class="flex-slider" id="owl-carousel-<?php echo $slider_id; ?>">
						...
						<?php
						$gallery_images = get_field('mod-occ-img');
						if( $gallery_images ): 
							...
							foreach( $gallery_images as $gallery_single_image ):
								...
								<img src="<?php echo $gallery_single_image['sizes']['main-image-size']; ?>" alt="<?php echo $gallery_single_image['alt']; ?>" />
			...
			<div class="mod-res-specs-wrap">
				<div class="mod-res-specs-block mr-block-1">
					...
					<span class="mod-res-spec mr-aang">Merk</span><span class="mod-res-value mr-aang"><?php the_field('mod-occ-brand'); ?></span>
					<span class="mod-res-spec mr-stat">Type</span><span class="mod-res-value mr-stat"><?php the_field('mod-occ-type'); ?></span>
					<span class="mod-res-spec mr-bouw">Bouwjaar</span><span class="mod-res-value mr-bouw"><?php the_field('mod-occ-yoc'); ?></span>
